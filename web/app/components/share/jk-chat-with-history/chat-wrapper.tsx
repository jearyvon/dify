...
import { useJkChat } from './hooks/use-jk-chat'
...
const ChatWrapper = () => {
  ...
  const appConfig = useMemo((): ChatConfig => {
    const config = appParams ?? {} as ChatConfig
  ...
  const {
    ...
    appConfig,
    {
      inputs: (currentConversationId ? currentConversationInputs : newConversationInputs) as Inputs,
  ...
  const onGetConversationMessages = useCallback(
    (conversationId: string) => fetchChatList(conversationId, appSourceType, appId || ''),
    [appSourceType, appId],
  )
  ...
  }, [onGetConversationMessages, handleSwitchSibling, currentConversationId, handleNewConversationCompleted, appSourceType, appId, appPrevChatTree])
  ...
  }, [inputsForms, currentConversationId, currentConversationInputs, newConversationInputs, chatList, handleSend, appSourceType, appId, isHistoryConversation, handleNewConversationCompleted, onGetConversationMessages])
  ...
  }, [handleSwitchSibling, currentConversationId, handleNewConversationCompleted, appSourceType, appId, onGetConversationMessages])
